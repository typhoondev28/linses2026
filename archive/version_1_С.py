...
directory = "D:\\_work\\linses\\merged_parquet\\"
base = "D:\\_work\\linses\\merged_parquet\\base\\"
...
def read_exp(exp: int) -> tuple[list[list[float]], list[list[float]]]:
    ...
    for i in range(N_time):
        # y_i, p_i = read_one_timefile_pd(i, prefix)
        y_i, p_i = y_i, p_i = read_one_timefile_parquet(i, prefix)
        y.append(y_i)
        p.append(p_i)
