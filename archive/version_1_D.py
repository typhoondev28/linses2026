...
merged_path = [
    r"c:\_work\linses\merged_parquet\base\NVIS.parquet",
    r"c:\_work\linses\merged_parquet\base\DNVIS.parquet",
    r"c:\_work\linses\merged_parquet\base\DVIS.parquet",
    r"c:\_work\linses\merged_parquet\3_freon_concave\MVIS.parquet",
    r"c:\_work\linses\merged_parquet\3_freon_concave\DMVIS.parquet",
]
